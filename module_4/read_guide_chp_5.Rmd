...
Let's illustrate what these formats look like with some real data.  The file home_ownership.txt contains "homeownership rates, in percentages, for a subset of states for the years 1985, 1996, and 2002. These values represent the proportion of homes owned by the occupant to the total number of occupied homes" (Ott & Longnecker, 2016, p. 129).   
