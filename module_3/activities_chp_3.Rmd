...
Many times you need to add special mathematical characters to your graphs, usually letters
from the Greek alphabet.  In order to do that, you'll need to use the `expression()` function.
...
Let's take a look at some code to see how this is done: 
...
## Helpful Resources for the Graphing Challenges 
Here are some helpful reference links as work on the graph challenges which follow.
...
## Challenge 3 (The Histogram, Boxplot, & Stripchart)
