...
## Introduction
Review the sample code and the *Ref* notes before working on the challenges.
...
With vectors created, we can now use the `table()` function to summarize our data.  In this example, the function generates simple frequency counts for each vector. Given this information, how might you calculate the percentage of sightings that involved abduction?
