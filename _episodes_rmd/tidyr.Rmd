---
title: Dataframe Manipulation with tidyr (Instructional Worksheet)
date: '`r Sys.Date()`'
output:
...
gapminder <- read.csv("../data/gapminder_FiveYearData.csv", header=TRUE, stringsAsFactors = FALSE)
...
> Download the wide version of the gapminder data from [here](https://github.com/mydatastory/r_intro_class/blob/master/data/gapminder_wide.csv)
