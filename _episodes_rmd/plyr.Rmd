---
title: Working with plyr (Instructional Worksheet)
date: '`r Sys.Date()`'
output:
...
![Split apply combine](../fig/plyr_fig1.png)
...
![Full apply suite](../fig/plyr_fig2.png)
...
do so).  To replace a for loop, put the code that was in the body of the `for` loop inside an anonymous function.
