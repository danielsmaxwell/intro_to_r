...
> ### *Ref: Functions*
> So what is a function? As defined by Webopedia, a software function is "a named section of a program that performs a specific task."  Functions are the workhorses of R, allowing programmers to do all kinds of things.
