...
> download.file("https://raw.githubusercontent.com/danielsmaxwell/intro_to_r/master/data/gapminder.csv", destfile = "gapminder.csv")
> gapminder <- read.csv("gapminder.csv")
> ```
>
...
this time, use what you've learned about factors, lists and vectors, as well as the output of functions like `colnames` and `dim` to explain what everything that `str` prints out for gapminder means.
