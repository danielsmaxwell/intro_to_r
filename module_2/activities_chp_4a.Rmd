---
title: "Activity Worksheet A: *R in Action* (Chapter 4)"
author: "Dan Maxwell"
date: "June 21, 2017"
output:
...
```{r}
gapminder <- read.csv("gapminder_FiveYearData.csv")
```
...
> download.file("https://raw.githubusercontent.com/danielsmaxwell/intro_to_r/master/data/gapminder_FiveYearData.csv", destfile = "gapminder_FiveYearData.csv")
> gapminder <- read.csv("gapminder_FiveYearData.csv")
> ```
>
> * Alternatively, you can also read in files directly into R from the Internet by replacing the file paths with a web address in `read.csv`. One should note that in doing this no local copy of the csv file is first saved onto your computer. For example,
> ```{r eval=FALSE, echo=TRUE}
> gapminder <- read.csv("https://raw.githubusercontent.com/danielsmaxwell/intro_to_r/master/data/gapminder_FiveYearData.csv")
> ```
>
...
to load in the gapminder dataset. Put it in your default working
directory.
...
> ```{r eval = FALSE}
> download.file("https://raw.githubusercontent.com/danielsmaxwell/intro_to_r/master/data/gapminder_FiveYearData.csv", destfile = "gapminder_FiveYearData.csv")
> gapminder <- read.csv(file = "gapminder_FiveYearData.csv")
> ```
...
If there are any parts you can't interpret, discuss with fellow students!
