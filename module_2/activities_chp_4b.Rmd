---
title: "Activity Worksheet B: *R in Action* (Chapter 4)"
author: "Dan Maxwell"
date: "June 21, 2017"
output:
...
![Equality testing](equality_1.png)

When one vector is shorter than the other, it gets *recycled*:

![Equality testing](equality_2.png)
...
> ### *Ref: R in Action (Section 4.10.4)* 
> I favor the `subset()` function over the use of indexes as outlined above.  It
> has an intuitive feel to it and the code is easier to read.  Even so, this is a
> personal preference and you might favor the use of indexes in your code. 
